...
<head>
    ...
    <title>Smart Campus Hub - Portfolio Project</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="../projects.html" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Projects</a>
    ...
    <div class="gradient-bg py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Smart Campus Hub</h1>
                <p class="text-xl text-gray-200 mb-8">Comprehensive Transport Management System</p>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-gray-300 mb-6">
                        Smart Campus Hub is a comprehensive transport management system designed for university campuses. 
                        It features real-time vehicle tracking, permit management, and role-based access control with a 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-900 rounded-xl p-8 border border-gray-700">
                <p class="text-gray-300 mb-6 text-center">
                    Experience the Smart Campus Hub with these demo accounts:
                </p>
    ...
    <footer class="bg-gray-900 border-t border-gray-800 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-gray-400">© 2024 Smart Campus Hub. All rights reserved.</p>
                </div>
